...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        Path path = Paths.get("/Users/aerinparker/Documents/flower/flowers.txt"); // sets path to write data
        ...
        try { // prevents IOException ?
            ...
            for (int i = 0; i < flowers.size(); i++) { // writes flower details to file
                ...
                Files.writeString(path, flowers.get(i).getFlowerName().toString() + ": " + flowers.get(i).getFlowerColor().toString() + ", " + String.valueOf(flowers.get(i).getFlowerPetals()) + ", " + String.valueOf(flowers.get(i).getFlowerScent()) + System.lineSeparator(), StandardOpenOption.APPEND);
            }
        }
        catch (Exception e) {
